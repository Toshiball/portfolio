		...
		<Box>
			<Paper elevation={3} style={{ padding: "20px", marginBottom: "20px" }}>
				...
				<Typography variant="body1" paragraph>
					...
					curiosité et la rigueur. C'est cette combinaison qui me motive à développer mes compétences, à
					m'investir dans des projets personnels tout en poursuivant mes objectifs professionnels.
				</Typography>
				<Typography variant="body1" paragraph>
					En dehors du travail, la musique occupe une place importante dans ma vie. J'apprécie une grande
					variété de genres musicaux, que ce soit en écoutant de la Dance/Electro, du rock ou même de la
					hardstyle, jusqu'aux classiques des années 90.
				</Typography>
				<Typography variant="body1" paragraph>
					Les jeux vidéo constituent également une passion pour moi. Que ce soit pour explorer les aventures
					solo où je me plonge dans l'histoire captivante d'un personnage, ou pour exprimer ma créativité à
					travers des jeux de construction, j'y trouve un moyen de me détendre et de m'évader. Je suis
