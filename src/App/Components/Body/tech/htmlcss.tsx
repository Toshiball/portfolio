	...
	return (
		<Box>
			...
			>
				...
				<Typography variant="body1" paragraph>
					Durant ma formation, j’ai eu l’opportunité de concevoir l’interface d’une application web en
					utilisant HTML et CSS. Cette mission demandait de respecter les standards du secteur tout en offrant
					une expérience utilisateur optimale.
				</Typography>
				<Typography variant="body1" paragraph>
					Lors de mon cursus scolaire, j'ai eu l'‍opportunité passionnante de concevoir l'interface
					utilisateur d'une application web en utilisant HTML/‍CSS. Cette mission exigeait le respect des
					standards de l'industrie tout en assurant une expérience utilisateur optimale. Notre objectif était
					clair : cré‍‍er une interface intuitive et attrayante pour maximiser l'‍engagement des utilisateurs.
					Grâ‍‍ce à ma maîtrise de HTML/CSS, j'‍ai pu réaliser des mises en page flexibles et réactives, en
					utilisant des techniques avancées telles que les grilles CSS et les médias queries pour garantir une
					compatibilité multiplateforme. Le résultat ? Une interface esthé‍‍tique et fonctionnelle qui a
				...
				<Typography variant="body1" paragraph>
					Mon niveau de maî‍‍trise dans ces technologies est confirmé, mais je reste constamment à l'‍affût
					des nouvelles techniques et tendances en matière de design web. Je m'‍efforce continuellement de
					perfectionner mes compé‍‍tences en responsive design afin d'offrir une expé‍rience utilisateur
					encore plus immersive.
				</Typography>
				<Typography variant="body1" paragraph>
					Dans mon rôle actuel, cette compé‍tence revêt une importance cruciale. Elle me permet de jouer un
					rôle actif dans le dé‍veloppement front-end des projets et de garantir la qualité‍ visuelle et
					ergonomique des produits finaux.
				</Typography>
				<Typography variant="body1" paragraph>
					Ayant travaillé‍ avec HTML/CSS pendant plusieurs anné‍es, j'ai acquis une expertise significative
					dans ces technologies. Je suis capable de travailler de manière autonome sur des projets, tout en
					restant ouvert à l'apprentissage de nouvelles mé‍thodes et outils pour optimiser mon flux de travail
					et rester compé‍titif sur le marché‍.
				</Typography>
				<Typography variant="body1" paragraph>
